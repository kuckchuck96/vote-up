...
export class VoteService {
  ...
  createVote(voteData: VoteData): Observable<VoteData> {
    return this.http.post<VoteData>(`${this.baseUrl}/create`, voteData, httpOptions);
  }
  ...
  closeVote(id: string): Observable<Vote> {
    return this.http.post<Vote>(`${this.baseUrl}/close/${id}`, httpOptions);
  }

  updateOption(id: string): Observable<VoteOption> {
    return this.http.post<VoteOption>(`${this.baseUrl}/update/${id}`, httpOptions);
  }
}
